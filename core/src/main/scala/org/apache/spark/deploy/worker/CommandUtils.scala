...
object CommandUtils extends Logging {
  ...
  def buildProcessBuilder(
    ...
    //该command即为appDesc.command，appDesc.command.mainClass值为org.apache.spark.executor.CoarseGrainedExecutorBackend
  ...
  private def buildLocalCommand(
    ...
    Command(
      command.mainClass, //org.apache.spark.executor.CoarseGrainedExecutorBackend
